...
// This screen displays the hard quiz.
...
export default function HardQuizPage() {
  ...
  // This is used to get the correct question from hardQuizData.
  ...
  // Gets the current question object from the hard quiz data array.
  ...
  // This prevents them from choosing multiple answers for one question.
  ...
  function handleAnswerPress(answer: string) {
    ...
    // Adds a short delay so the user can see the answer feedback
    // before the quiz moves to the next question or result page.
    setTimeout(() => {
      ...
      if (isLastQuestion) {
        ...
        // Moves to the next question and clears the selected answer
        // so the next question starts with no answer selected.
  ...
  // This allows correct answers to show as correct and wrong selected answers to show as wrong.
...
const styles = StyleSheet.create({
  ...
  // The padding keeps the content away from the screen edges.
  container: {
    width: "100%",
    padding: 16,
  },
