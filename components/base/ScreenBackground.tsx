...
// It provides the safe area, blue gradient background, star image overlay, and scrollable content area used across the app.
export default function ScreenBackground({ children }: ScreenBackgroundProps) {
  return (
    <SafeAreaView style={styles.safeArea}>

      {/* LinearGradient creates the main blue background for the screen. The rgba colours allow the background to have a softer layered look. */}
      <LinearGradient
      ...
      >
        ...
        >
          {/* ScrollView allows the page content to scroll if it does not fit on smaller screens or when the content becomes taller.*/}
          <ScrollView
